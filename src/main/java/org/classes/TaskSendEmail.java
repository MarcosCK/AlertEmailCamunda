...
public class TaskSendEmail implements TaskListener{
    ...
    private final static Logger LOGGER = Logger.getLogger(TaskSendEmail.class.getName());
        ...
        if (assignee != null) {
            ...
            if (user != null) {
                ...
                try {
                    ...
                    LOGGER.log(Level.WARNING, "Não foi possível enviar email", e.getMessage());
                }
            } else {
